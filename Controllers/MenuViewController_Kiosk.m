...
-(IBAction)actionOpenPlainDocument:(NSString *)name {
	//NSLog(@"%@", documentName);
	
	NSString *phrase = nil;
	
	NSString *documentName = [NSString stringWithFormat:@"%@.pdf", name]; assert(documentName != nil);
	...
	if (document == nil) {
		...
		NSString *filePath = [documentsDirectory stringByAppendingPathComponent:[NSString stringWithFormat:@"%@/%@.pdf", name, name]];
